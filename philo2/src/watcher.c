...
/*   Updated: 2025/04/02 15:31:24 by sithomas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	simulation_done(t_philo *table, int i, int type);
...
static int	check_if_dead(t_philo *philo)
{
	...
	if (actual_time(philo->rules) > philo->last_meal_stamp + philo->rules->die_time)
	{
